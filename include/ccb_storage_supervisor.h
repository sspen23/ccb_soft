...
typedef struct {
    ...
    uint32_t stop_requested_mask; bool first_fatal; uint32_t fatal_channel; char fatal_reason[64];
    WriteResult final_result[NUM_CHANNELS]; bool aggregate_emitted; StorageTaskTerminal terminal;
