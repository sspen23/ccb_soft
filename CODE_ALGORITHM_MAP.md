...
storage_pipeline channel=... window_ms=5000 rx_mib_s=... nvme_complete_mib_s=...
...
nvme_cmd_submitted_window=... nvme_cmd_completed_window=...
...
storage_transfer_done channel=... task=... file_index=...
  ...
  nvme_write_ms=...
  file_mib_s=...
  nvme_active_mib_s=... nvme_wall_mib_s=...
  dma_desc_completed_count=...
  dma_harvest_interval_min_us=...
  dma_harvest_interval_max_us=...
  dma_harvest_interval_avg_us=...
  nvme_cmd_size_bytes=...
  nvme_cmd_count=...
...
| `nvme_active_mib_s` | writer 实际执行 NVMe 写操作期间的吞吐 |
| `nvme_wall_mib_s` | 第一次成功 submit 到最后一次 completion 的持续墙钟吞吐 |
